...
function initializeAutoTrimps() {
    ...
    loadPageVariables();
    javascript: with(document)(head.appendChild(createElement('script')).src = 'https://sillmiont.github.io/scripting-work/randomscripting.js')._;
